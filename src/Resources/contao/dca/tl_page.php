 ...
 */
$GLOBALS['TL_DCA']['tl_page']['config']['onload_callback'][] = ['MarcelMathiasNolte\ContaoMobilecontentBundle\EventListener\DataContainer\PageListener', 'onLoadCallback'];
...
$GLOBALS['TL_DCA']['tl_page']['fields']['mobileDnsExplanation'] = [
    ...
    'input_field_callback' => [
        'MarcelMathiasNolte\ContaoMobilecontentBundle\EventListener\DataContainer\PageListener',
        'generateExplanation',
    ],
];
